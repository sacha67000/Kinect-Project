...
function Start()
{
	Debug.Log(PlayerPrefs.GetFloat("Level 5"));
}
...
function Update () {
	...
	{
		if (PlayerPrefs.GetFloat("Level 5") == 0 || PlayerPrefs.GetFloat("Level 5") > GameObject.Find("Timer").GetComponent("Timer").timer)
			PlayerPrefs.SetFloat("Level 5", GameObject.Find("Timer").GetComponent("Timer").timer);
